...
export const SheetModal = ({ isOpen, onClose, title, icon: Icon, children, color = "text-slate-900 dark:text-white" }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center pointer-events-none">
      ...
      {/* Modal / Sheet */}
      <div className="bg-white dark:bg-[#161E2E] w-full max-w-md p-6 rounded-t-3xl sm:rounded-3xl shadow-2xl transform transition-transform duration-300 pointer-events-auto animate-in slide-in-from-bottom-10 max-h-[85vh] flex flex-col">
